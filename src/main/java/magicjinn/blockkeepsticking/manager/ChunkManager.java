...
public class ChunkManager implements ChunkUnloadCallback {
	...
	public void processChunk(WorldChunk chunk) {
		...
		if (chunk == null || !(chunk.getWorld() instanceof ServerWorld)) return;
		if (!hasProcessableEntities(chunk)) return;
