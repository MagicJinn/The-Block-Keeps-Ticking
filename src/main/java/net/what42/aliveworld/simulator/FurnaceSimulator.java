...
public class FurnaceSimulator {
    ...
    public void simulateFinalResult(int tickPassed, World world, FurnaceAccess furnace) {
        ...
        Optional<AbstractCookingRecipe> recipe = world.getRecipeManager()
                .getFirstMatch(type, new SimpleInventory(ingredient()), world);
        ...
        if (maxOperations > 0) {
            ...
            dataChanged = true;
            AliveWorld.LOGGER.info("Aplying final result: {} operations", maxOperations);
        }
    }
